...
declare -A FONTS=( \
                    ...
                    ["Roboto Condensed Italic"]="fonts/google-fonts/apache/robotocondensed/RobotoCondensed-Italic.ttf" \
                    ["Roboto Regular"]="fonts/google-fonts/apache/roboto/Roboto-Regular.ttf" \
                 )
mkdir -p "${GLYPHS_DIR}"
